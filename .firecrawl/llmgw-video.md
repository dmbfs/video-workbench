...
## [What Works Today](https://docs.llmgateway.io/features/video-generation\#what-works-today)
...
## [Request Format](https://docs.llmgateway.io/features/video-generation\#request-format)

LLMGateway currently supports a focused subset of the OpenAI video API.

### [Supported fields](https://docs.llmgateway.io/features/video-generation\#supported-fields)
...
### [Sizes and durations by model](https://docs.llmgateway.io/features/video-generation\#sizes-and-durations-by-model)
...
### [First/last frame inputs](https://docs.llmgateway.io/features/video-generation\#firstlast-frame-inputs)
...
| `last_frame` | no (needs `image`) | HTTPS URL **or** base64 data URL | **Seedance 2.x** (`bytedance`), **KLING v3.0 / Turbo** (`atlascloud`), Veo 3.1 (`google-vertex`) |

#### [Rules and limits](https://docs.llmgateway.io/features/video-generation\#rules-and-limits)
...
#### [Example (Seedance 2.0)](https://docs.llmgateway.io/features/video-generation\#example-seedance-20)
...
#### [Example (KLING v3.0 image-to-video)](https://docs.llmgateway.io/features/video-generation\#example-kling-v30-image-to-video)
...
### [Reference-guided generation (Seedance 2.x)](https://docs.llmgateway.io/features/video-generation\#reference-guided-generation-seedance-2x)
...
#### [Rules and limits](https://docs.llmgateway.io/features/video-generation\#rules-and-limits-1)
...
#### [Examples](https://docs.llmgateway.io/features/video-generation\#examples)
...
### [Not supported yet](https://docs.llmgateway.io/features/video-generation\#not-supported-yet)

- multipart uploads
- `n` values other than `1`
- remix/list/delete video endpoints

## [Create a Video](https://docs.llmgateway.io/features/video-generation\#create-a-video)
...
## [Retrieve Job Status](https://docs.llmgateway.io/features/video-generation\#retrieve-job-status)
...
## [Download the Video](https://docs.llmgateway.io/features/video-generation\#download-the-video)
...
## [Signed Callbacks](https://docs.llmgateway.io/features/video-generation\#signed-callbacks)
...
### [Delivery behavior](https://docs.llmgateway.io/features/video-generation\#delivery-behavior)
...
### [Headers](https://docs.llmgateway.io/features/video-generation\#headers)

- `webhook-id`
- `webhook-timestamp`
- `webhook-signature`

### [Signature format](https://docs.llmgateway.io/features/video-generation\#signature-format)
...
### [Verification example](https://docs.llmgateway.io/features/video-generation\#verification-example)
...
## [Related Docs](https://docs.llmgateway.io/features/video-generation\#related-docs)
...
Last updated on 9/5/2026

[Transcription\\
\\
Transcribe audio into text (speech-to-text) with word-level timestamps through the audio transcriptions API](https://docs.llmgateway.io/features/transcription) [Vision Support\\
\\
Learn how to send images to vision-enabled models using URLs or inline base64 data.](https://docs.llmgateway.io/features/vision)

### On this page

[What Works Today](https://docs.llmgateway.io/features/video-generation#what-works-today) [Request Format](https://docs.llmgateway.io/features/video-generation#request-format) [Supported fields](https://docs.llmgateway.io/features/video-generation#supported-fields) [Sizes and durations by model](https://docs.llmgateway.io/features/video-generation#sizes-and-durations-by-model) [First/last frame inputs](https://docs.llmgateway.io/features/video-generation#firstlast-frame-inputs) [Rules and limits](https://docs.llmgateway.io/features/video-generation#rules-and-limits) [Example (Seedance 2.0)](https://docs.llmgateway.io/features/video-generation#example-seedance-20) [Example (KLING v3.0 image-to-video)](https://docs.llmgateway.io/features/video-generation#example-kling-v30-image-to-video) [Reference-guided generation (Seedance 2.x)](https://docs.llmgateway.io/features/video-generation#reference-guided-generation-seedance-2x) [Rules and limits](https://docs.llmgateway.io/features/video-generation#rules-and-limits-1) [Examples](https://docs.llmgateway.io/features/video-generation#examples) [Not supported yet](https://docs.llmgateway.io/features/video-generation#not-supported-yet) [Create a Video](https://docs.llmgateway.io/features/video-generation#create-a-video) [Retrieve Job Status](https://docs.llmgateway.io/features/video-generation#retrieve-job-status) [Download the Video](https://docs.llmgateway.io/features/video-generation#download-the-video) [Signed Callbacks](https://docs.llmgateway.io/features/video-generation#signed-callbacks) [Delivery behavior](https://docs.llmgateway.io/features/video-generation#delivery-behavior) [Headers](https://docs.llmgateway.io/features/video-generation#headers) [Signature format](https://docs.llmgateway.io/features/video-generation#signature-format) [Verification example](https://docs.llmgateway.io/features/video-generation#verification-example) [Related Docs](https://docs.llmgateway.io/features/video-generation#related-docs)

[Ready for production?\\
\\
Ship to production with SSO, audit logs, spend controls, and guardrails your security team will approve.\\
Explore Enterprise](https://llmgateway.io/enterprise)